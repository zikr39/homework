create database lesson7homework
use lesson7homework
---------------------------
...
----7
select DepartmentName, count(*) as AllEmployees from Employees
...
group by CustomerID
----10
select DepartmentName, count(*) as TotalEmployees from Employees
group by DepartmentName
having count(*) > 5
----11
select ProductID, count(SaleAmount) as TotalSales, avg(SaleAmount) as AvgSales from Sales
group by ProductID
----12
select count(*) as HR_Employees from Employees
where DepartmentName = 'HR'
----13
select DepartmentName, max(Salary) as HighSalary, min(Salary) as LowestSalary from Employees
group by DepartmentName
----14
select DepartmentName, avg(Salary) as AvgSalary from Employees
group by DepartmentName
----15
select DepartmentName, avg(Salary) as AvgSalary, count(*) as EmployeeCount from Employees
group by DepartmentName
----16
...
----23
select o.CustomerID,
       sum(case when o.Freight > 50 then o.Freight else 0 end) as TotalAmountOver50,
