...
----7
select e.Name from Departments as d
...
----9
select p.OrderID, o.PaymentID from Orders as p
join Payments as o on p.OrderID=o.OrderID
----10
select o.OrderID from Products as p
join Orders as o on p.ProductID=o.ProductID
where p.Price>100
----11
...
where c.Country = 'USA'
----20
select o.OrderID, o.OrderDate, o.TotalAmount, c.FirstName, c.Country
from Orders o
...
----22
select p.PaymentID,p.OrderID,p.Amount as PaidAmount,o.Quantity,
pr.Price as ProductPrice,(o.Quantity * pr.Price) as ExpectedAmount
from Payments p
...
----24
select distinct m.EmployeeID, m.Name,m.Salary
from Employees m
join Employees e on e.ManagerID = m.EmployeeID
where m.Salary <= e.Salary
----25
select distinct c.CustomerID,c.FirstName from Customers c
